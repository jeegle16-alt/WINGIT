...
# -----------------------------------------------------------------------------
STUDIO_BUCKET = "sagemaker-studio-558853120313-37b94c10"
FOLDER = "flights"
...
DEFAULT_MLFLOW_TRACKING_URI = (
    "arn:aws:sagemaker:us-east-1:558853120313:mlflow-tracking-server/flights"
)
...
def get_pipeline(
    ...
    step_preprocess = ProcessingStep(
        ...
        job_arguments=[
            "--input-file", "/opt/ml/processing/input/raw_data.csv",
    ...
    processed_uri = step_preprocess.properties.ProcessingOutputConfig.Outputs["processed"].S3Output.S3Uri
    ...
    estimator = XGBoost(
        ...
        environment={**mlflow_env, "MLFLOW_RUN_NAME": "train", "MLFLOW_NESTED": "0"},
    )
    ...
    step_train = TrainingStep(
        ...
        inputs={
            ...
            # ✅ [필수 수정] content_type 제거 (prefix 내려받아 디렉터리로 사용)
            "preprocess": TrainingInput(s3_data=processed_uri),
        },
    ...
    step_test = ProcessingStep(
        ...
        job_arguments=[
            ...
            "--test-file", "test_numeric.csv",
            "--output-dir", "/opt/ml/processing/output",
            "--extract-dir", "/opt/ml/processing/model_extracted",
            "--target-transform", "log1p",
        ],
    )

    test_output_uri = step_test.properties.ProcessingOutputConfig.Outputs["test_output"].S3Output.S3Uri
    ...
    step_register = ProcessingStep(
        ...
        job_arguments=[
            "--model-tar", step_train.properties.ModelArtifacts.S3ModelArtifacts,
            "--model-group", MODEL_GROUP_NAME,
            "--region", region,
            "--role-arn", role,
            "--preprocess-image-uri", sklearn_infer_image,
            "--xgb-image-uri", xgb_infer_image,
            "--artifact-bucket", param_artifact_bucket,
            "--artifact-prefix", param_artifact_prefix,
            "--metrics-s3-uri", metrics_s3_uri,
        ],
    )
    ...
    step_deploy = ProcessingStep(
        ...
        job_arguments=[
            "--model-group", MODEL_GROUP_NAME,
            "--endpoint-name", param_endpoint_name,
            "--region", region,
            "--instance-type", param_instance_type,
            "--initial-instance-count", param_deploy_initial_instance_count.to_string(),
            "--role-arn", role,
            "--wait",
        ],
    )
    ...
    return Pipeline(
        ...
        steps=[step_preprocess, step_train, step_test, step_register, step_deploy],
