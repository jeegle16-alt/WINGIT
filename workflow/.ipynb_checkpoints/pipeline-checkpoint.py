...
def get_pipeline(
    ...
    featurizer_s3 = Join(on="/", values=[processed_uri, "featurizer.joblib"])
    target_transform_s3 = Join(on="/", values=[processed_uri, "target_transform.json"])
    ...
    step_train = TrainingStep(
        ...
        inputs={
            ...
            "featurizer": TrainingInput(s3_data=featurizer_s3, content_type="application/octet-stream"),
            "target_transform": TrainingInput(s3_data=target_transform_s3, content_type="application/json"),
        },
